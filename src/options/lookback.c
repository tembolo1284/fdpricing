/* src/options/lookback.c - Lookback option pricing */
    ...
    int n_time)
{
    ...
    /* Create grid */
    double s_min = 0.0;
    double s_max = 3.0 * fmax(spot, current_min);
    ...
    /* Create lookback call option (floating strike) */
    fdp_option_t* option = fdp_option_new_lookback(
        ctx,
        FDP_OPTION_CALL,
        0.0,          /* strike = 0 for floating */
        maturity,
        0             /* is_fixed_strike = 0 */
    );
    ...
    int n_time)
{
    ...
    /* Create grid */
    double s_min = 0.0;
    double s_max = 3.0 * fmax(spot, current_max);
    ...
    /* Create lookback put option (floating strike) */
    fdp_option_t* option = fdp_option_new_lookback(
        ctx,
        FDP_OPTION_PUT,
        0.0,          /* strike = 0 for floating */
...
/* ========================================================================
 * Lookback Call Option (Fixed Strike)
 * ======================================================================== */
    ...
    int n_time)
{
    ...
    /* Create grid */
    double s_min = 0.0;
    double s_max = 3.0 * fmax(spot, fmax(strike, current_max));
    ...
    /* Create lookback call option (fixed strike) */
    fdp_option_t* option = fdp_option_new_lookback(
        ctx,
        FDP_OPTION_CALL,
        strike,
...
/* ========================================================================
 * Lookback Put Option (Fixed Strike)
 * ======================================================================== */
    ...
    int n_time)
{
    ...
    /* Create grid */
    double s_min = 0.0;
    double s_max = 3.0 * fmax(spot, fmax(strike, current_min));
    ...
    /* Create lookback put option (fixed strike) */
    fdp_option_t* option = fdp_option_new_lookback(
        ctx,
        FDP_OPTION_PUT,
        strike,
